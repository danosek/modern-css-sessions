  ...
  const sessions = [
    {
      ...
      topics: [
        { id: 't1', name: 'Intrinsic Sizing', demos: [
          { slug: 'sizing-values', index: 'D1', name: 'min-content · max-content · fit-content' },
          { slug: 'sizing-layout', index: 'D2', name: 'V gridu · centrování' },
        ] },
        { id: 't2', name: 'min() · max() · clamp()', demos: [
          { slug: 'min-width',   index: 'D1', name: 'min() — strop šířky' },
          { slug: 'max-width',   index: 'D2', name: 'max() — podlaha šířky' },
          { slug: 'max-min',     index: 'D3', name: 'min() + max() — centrování' },
        ...
        { id: 't3', name: 'Logical Properties', demos: [
          ...
          { slug: 'physical-vs-logical', index: 'D2', name: 'dir' },
          { slug: 'writing-mode',        index: 'D3', name: 'writing-mode' },
        ...
        { id: 't5', name: '@layer', demos: [
          { slug: 'live-cascade', index: 'D1', name: 'Prohoď pořadí vrstev' },
          { slug: 'layer-order',  index: 'D2', name: 'Pořadí bije specificitu' },
          { slug: 'examples',     index: 'D3', name: 'Vendor CSS · revert-layer' },
        ] },
        { id: 't6', name: ':has() · :is() · :where()', demos: [
          { slug: 'live-checklist', index: 'D1', name: ':has(input:checked)' },
          { slug: 'examples',       index: 'D2', name: ':has() v praxi' },
          { slug: 'is-where',       index: 'D3', name: ':is() · :where()' },
        ] },
        { id: 't7', name: 'Container Queries', demos: [
          { slug: 'live-resize',    index: 'D1', name: 'Resize kontejneru' },
          { slug: 'three-contexts', index: 'D2', name: 'Jedna karta, tři kontexty' },
          { slug: 'range-queries',  index: 'D3', name: 'Range syntaxe' },
        ] },
