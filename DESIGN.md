...
description: >
  ...
  Seed projektu modern-css-sessions: brandPrimary=electricviolet, brandSecondary=torchred,
  contrastLevel=a, fontFamilyMain=ia-writer-quattro, fontFamilyHeadings=departure-mono,
  fontFamilyMonospace=ia-writer-mono, fontBaseSize=15px, scaleRatio=1.2.

colors:
  palette:
    electricviolet:
      10:  { $type: color, $value: "oklch(95% 0.29 285)" }
      20:  { $type: color, $value: "oklch(89% 0.29 285)" }
      30:  { $type: color, $value: "oklch(84% 0.29 285)" }
      40:  { $type: color, $value: "oklch(80% 0.29 285)" }
      50:  { $type: color, $value: "oklch(52% 0.27 285)" }
      60:  { $type: color, $value: "oklch(49.4% 0.288 285)", $description: "Brand primary base" }
      70:  { $type: color, $value: "oklch(54% 0.29 285)" }
      80:  { $type: color, $value: "oklch(48% 0.29 285)" }
      90:  { $type: color, $value: "oklch(40% 0.29 285)" }
      100: { $type: color, $value: "oklch(30% 0.29 285)" }
    torchred:
      60: { $type: color, $value: "oklch(63.1% 0.254 24.5)", $description: "Brand secondary base" }
    green:
      60: { $type: color, $value: "oklch(50% 0.22 146)", $description: "Status success base" }
    amber:
      60: { $type: color, $value: "oklch(83% 0.17 82)", $description: "Status warning base" }
    red:
      60: { $type: color, $value: "oklch(51% 0.22 28)", $description: "Status error base" }
    lightblue:
      60: { $type: color, $value: "oklch(80% 0.19 230)", $description: "Status information base" }

  brand:
    primary:
      $type: color
      $value: "light-dark(oklch(49.4% 0.288 285), oklch(77% 0.27 285))"
      $description: "Dominantní barva aplikace — tlačítka, checkboxy, aktivní stavy. Electric violet."
    secondary:
      $type: color
      $value: "light-dark(oklch(63.1% 0.254 24.5), oklch(78% 0.22 24.5))"
      $description: "Doplňující barva — navigace, záložky. Torch red."

  status:
    success:
      $type: color
      $value: "light-dark(oklch(51% 0.2 146), oklch(74% 0.17 146))"
      $description: "Úspěšné stavy. Green."
    warning:
      $type: color
      $value: "light-dark(oklch(57% 0.17 82), oklch(67% 0.15 82))"
      $description: "Varování. Amber."
    error:
      $type: color
      $value: "light-dark(oklch(51% 0.22 28), oklch(79% 0.2 28))"
      $description: "Chyby a kritické stavy. Red."
    information:
      $type: color
      $value: "light-dark(oklch(57% 0.19 230), oklch(71% 0.16 230))"
      $description: "Neutrální oznámení. Lightblue."

  surface:
    base:
      $type: color
      $value: "light-dark(oklch(90% 0.01024 250), oklch(4% 0.01842 250))"
      $description: "Základní pozadí dokumentu/stránky."
    baseVariant:
      $type: color
      $value: "light-dark(oklch(100% 0 250), oklch(0% 0 250))"
      $description: "Varianta základního pozadí — čisté bílé/černé."
    main:
      $type: color
      $value: "light-dark(oklch(98% 0.00419 250), oklch(24% 0.00962 250))"
      $description: "Základní povrch elementu (karty, panely)."
    mainDim:
      $type: color
      $value: "light-dark(oklch(96% 0.00819 250), oklch(20% 0.01566 250))"
      $description: "Tlumený element — mírně temnější než main."
    mainVariant:
      $type: color
      $value: "light-dark(oklch(94% 0.0128 250), oklch(32% 0.02167 250))"
      $description: "Varianta elementu se zvýšenou saturací."
    mainBright:
      $type: color
      $value: "light-dark(oklch(100% 0.00819 250), oklch(34% 0.01566 250))"
      $description: "Výrazný element — světlejší alternativa."
    control:
      $type: color
      $value: "light-dark(oklch(100% 0.00655 250), oklch(34% 0.01331 250))"
      $description: "Povrch ovládacích prvků (inputy, selecty, buttony)."
    controlVariant:
      $type: color
      $value: "light-dark(oklch(100% 0.00655 250), oklch(20% 0.01331 250))"
      $description: "Varianta ovládacího prvku — tmavší podklad."
    front:
      $type: color
      $value: "light-dark(oklch(100% 0.00819 250), oklch(30% 0.01566 250))"
      $description: "Popředí pop-upů, dropdownů, tooltipů."

  text:
    primary:
      $type: color
      $value: "light-dark(oklch(2% 0 250), oklch(98% 0 250))"
      $description: "Primární text. Kontrast > 4,5:1."
    primaryVariant:
      $type: color
      $value: "light-dark(oklch(35% 0 250), oklch(85% 0 250))"
      $description: "Varianta primárního textu. Kontrast > 3:1."
    secondary:
      $type: color
      $value: "light-dark(oklch(49% 0 250), oklch(77% 0 250))"
      $description: "Méně důležitý text. Kontrast > 4,5:1."
    secondaryVariant:
      $type: color
      $value: "light-dark(oklch(58% 0 250), oklch(66% 0 250))"
      $description: "Varianta sekundárního textu. Kontrast > 3:1."
    disabled:
      $type: color
      $value: "light-dark(oklch(69% 0 250), oklch(56% 0 250))"
      $description: "Neaktivní prvky."
    brandPrimary:
      $type: color
      $value: "light-dark(oklch(49.4% 0.288 285), oklch(77% 0.27 285))"
      $description: "Primární brand barva textu. Electric violet."
    brandSecondary:
      $type: color
      $value: "light-dark(oklch(63.1% 0.254 24.5), oklch(78% 0.22 24.5))"
      $description: "Sekundární brand barva textu. Torch red."
    statusError:
      $type: color
      $value: "light-dark(oklch(51% 0.22 28), oklch(79% 0.2 28))"
    statusWarning:
    ...
    rightsPostponedRequired:
      $type: color
      $value: "light-dark(oklch(63.1% 0.254 24.5), oklch(78% 0.22 24.5))"
      $description: "Odloženě povinné. Torch red."
    rightsRecommended:
      $type: color
  ...
  overlay:
    subtle:
      $type: color
      $value: "light-dark(oklch(20% 0.1 250 / 0.2), oklch(80% 0.03 250 / 0.15))"
    default:
      $type: color
      $value: "light-dark(oklch(20% 0.1 250 / 0.4), oklch(80% 0.03 250 / 0.3))"
    strong:
      $type: color
      $value: "light-dark(oklch(20% 0.1 250 / 0.6), oklch(80% 0.03 250 / 0.5))"
...
borderRadius:
  subtle: { $type: dimension, $value: "4px",     $description: "--radius-subtle" }
  default:{ $type: dimension, $value: "6px",      $description: "--radius — výchozí pro komponenty" }
  strong: { $type: dimension, $value: "12px",     $description: "--radius-strong" }
  circle: { $type: dimension, $value: "10000px",  $description: "--radius-circle — badges, avatary, toggle" }

border:
  minimal:
    $type: color
    $value: "light-dark(oklch(20% 0.1 250 / 0.04), oklch(80% 0.03 250 / 0.08))"
    $description: "--border-minimal — sotva viditelná linka"
  subtle:
    $type: color
    $value: "light-dark(oklch(20% 0.1 250 / 0.1), oklch(80% 0.03 250 / 0.12))"
    $description: "--border-subtle — jemná linka"
  default:
    $type: color
    $value: "light-dark(oklch(20% 0.1 250 / 0.2), oklch(80% 0.03 250 / 0.24))"
    $description: "--border — výchozí ohraničení"
  strong:
    $type: color
    $value: "light-dark(oklch(20% 0.1 250 / 0.3), oklch(80% 0.03 250 / 0.32))"
    $description: "--border-strong — výraznější linka pro inputy"
  contrast:
    $type: color
    $value: "light-dark(oklch(20% 0.1 250 / 0.5), oklch(80% 0.03 250 / 0.54))"
    $description: "--border-contrast — velmi výrazná linka"
  shiny:
    $type: color
    $value: "light-dark(oklch(100% 0 250 / 0.36), oklch(100% 0 250 / 0.08))"
    $description: "--border-shiny — odlesk na kartách, listech, widgetech"
  variant:
    $type: color
    $value: "light-dark(oklch(20% 0.1 250 / 0.2), oklch(20% 0.03 250 / 0.9))"
    $description: "--border-variant — vždy tmavá linka (i v tmavém tématu)"

shadow:
  elevationSubtle:
    $type: shadow
    $value: "0 1px 1px light-dark(oklch(0.1 0.04 250 / 0.06), oklch(0 0.04 250 / 0.06)), 0 1px 2px light-dark(oklch(0.1 0.04 250 / 0.04), oklch(0 0.04 250 / 0.04))"
    $description: "--elevation-subtle — stisklé tlačítko"
  elevation:
    $type: shadow
    $value: "0 1px 2px light-dark(oklch(0.1 0.04 250 / 0.1), oklch(0 0.04 250 / 0.1)), 0 3px 5px -1px light-dark(oklch(0.1 0.04 250 / 0.08), oklch(0 0.04 250 / 0.08))"
    $description: "--elevation — tlačítka, widgety, karty"
  elevationStrong:
    $type: shadow
    $value: "0 8px 24px light-dark(oklch(0.1 0.04 250 / 0.16), oklch(0 0.04 250 / 0.16)), 0 8px 24px -3px light-dark(oklch(0.1 0.04 250 / 0.28), oklch(0 0.04 250 / 0.28))"
    $description: "--elevation-strong — dropdown, popup, toast"
  elevationExtreme:
    $type: shadow
    $value: "0 20px 48px light-dark(oklch(0.1 0.04 250 / 0.2), oklch(0 0.04 250 / 0.2)), 0 20px 48px -5px light-dark(oklch(0.1 0.04 250 / 0.32), oklch(0 0.04 250 / 0.32))"
    $description: "--elevation-extreme — výhradně pro dialog"
  embossment:
    $type: shadow
    $value: "inset 0 2px 3px -1px light-dark(oklch(0.1 0.04 250 / 0.1), oklch(0 0.04 250 / 0.1))"
...
**Seed projektu modern-css-sessions (v. 26.2.1):**
- `brandPrimary` = electricviolet (`#6104f9`, `oklch(49.4% 0.288 285)`)
- `brandSecondary` = torchred (`#ff062f`, `oklch(63.1% 0.254 24.5)`)
...
CSS proměnné: `--[color]-[10-100]`, např. `--electricviolet-60: oklch(49.4% 0.288 285)`, `--torchred-60: oklch(63.1% 0.254 24.5)`.
...
| Light Green | 135 | Electric Violet | 285 |
| Lime | 128 | Torch Red | 24.5 |

### Funkční barvy

**Brand** — identita produktu (konfigurováno v seed):
- Primární (electricviolet): `--brand-primary-*` aliasuje `--electricviolet-*`
- Sekundární (torchred): `--brand-secondary-*` aliasuje `--torchred-*`

**Status** — výsledky akcí a systémové zprávy:
- `success` → green (`oklch(50% 0.22 146)`)
- `warning` → amber (`oklch(83% 0.17 82)`)
- `error` → red (`oklch(51% 0.22 28)`)
- `information` → lightblue (`oklch(80% 0.19 230)`)

Nepoužívejte `--red-*`/`--green-*` přímo pro status — vždy `--status-error-*`/`--status-success-*`.

**Práva** — povinnosti ve formulářích:
- `rights-required` → yellow
- `rights-postponed-required` → torchred
...
|-------|-------|----------------|
| `minimal` | Nenápadné pozadí, lehký nádech barvy | `--surface-electricviolet-minimal` |
| `subtle` | Nízká, ale patrná vizuální přítomnost | `--surface-electricviolet-subtle` |
| `moderate` | Normovaný jas a chroma napříč barvami | `--surface-electricviolet-moderate` |
| `strong` | Výrazné prvky, zachovaný jas barvy | `--surface-electricviolet-strong` |
| `contrast` | Maximální kontrast, invertuje vztah světlé/tmavé | `--surface-electricviolet-contrast` |
| `main` | Kombinace moderate + main | `--surface-electricviolet-main` |
...
| Token | Light | Dark |
|-------|-------|------|
| `--surface-base` | `oklch(90% 0.01024 250)` | `oklch(4% 0.01842 250)` |
| `--surface-base-variant` | `oklch(100% 0 250)` | `oklch(0% 0 250)` |
| `--surface-main` | `oklch(98% 0.00419 250)` | `oklch(24% 0.00962 250)` |
| `--surface-main-dim` | `oklch(96% 0.00819 250)` | `oklch(20% 0.01566 250)` |
| `--surface-main-variant` | `oklch(94% 0.0128 250)` | `oklch(32% 0.02167 250)` |
| `--surface-main-bright` | `oklch(100% 0.00819 250)` | `oklch(34% 0.01566 250)` |
| `--surface-front` | `oklch(100% 0.00819 250)` | `oklch(30% 0.01566 250)` |
| `--surface-control` | `oklch(100% 0.00655 250)` | `oklch(34% 0.01331 250)` |
| `--surface-control-variant` | `oklch(100% 0.00655 250)` | `oklch(20% 0.01331 250)` |
...
|-------|-------|------|----------|
| `--text-primary` | `oklch(2% 0 250)` | `oklch(98% 0 250)` | > 4,5:1 |
| `--text-primary-variant` | `oklch(35% 0 250)` | `oklch(85% 0 250)` | > 3:1 |
| `--text-secondary` | `oklch(49% 0 250)` | `oklch(77% 0 250)` | > 4,5:1 |
| `--text-secondary-variant` | `oklch(58% 0 250)` | `oklch(66% 0 250)` | > 3:1 |
| `--text-disabled` | `oklch(69% 0 250)` | `oklch(56% 0 250)` | — |
...
|----------|---------|---------|
| `--radius-subtle` | 4 px | Drobné prvky, tagy |
| `--radius` | 6 px | Výchozí pro komponenty |
| `--radius-strong` | 12 px | Karty, panely, modaly |
| `--radius-circle` | 10 000 px | Badges, avatary, toggle |
...
|----------|----------------|----------------|
| `--border-minimal` | `oklch(20% 0.1 250 / 0.04)` | `oklch(80% 0.03 250 / 0.08)` |
| `--border-subtle` | `oklch(20% 0.1 250 / 0.1)` | `oklch(80% 0.03 250 / 0.12)` |
| `--border` | `oklch(20% 0.1 250 / 0.2)` | `oklch(80% 0.03 250 / 0.24)` |
| `--border-strong` | `oklch(20% 0.1 250 / 0.3)` | `oklch(80% 0.03 250 / 0.32)` |
| `--border-contrast` | `oklch(20% 0.1 250 / 0.5)` | `oklch(80% 0.03 250 / 0.54)` |
| `--border-shiny` | `oklch(100% 0 250 / 0.36)` | `oklch(100% 0 250 / 0.08)` |
| `--border-variant` | `oklch(20% 0.1 250 / 0.2)` | `oklch(20% 0.03 250 / 0.9)` |
...
Barva stínů: `light-dark(oklch(0.1 0.04 250 / α), oklch(0 0.04 250 / α))` — v světlém tématu tmavě modrá, v tmavém černá.
...
**Globální tokeny** — konkrétní hodnoty (barva, radius, velikost). Nikdy nepoužívejte přímo v komponentách. Příklad: `--electricviolet-60: oklch(49.4% 0.288 285)`, `--base: 8px`, `--radius: 6px`.
