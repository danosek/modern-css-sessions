...
Vytvoř `shared/demo-base.css`. Výhradně Spectro tokeny – žádné hardcoded hodnoty.

```css
/* demo-base.css – sdílený wrapper pro všechna CSS dema */
...
/* Volitelný code block pod demem */
.demo-code {
